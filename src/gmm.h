...
/* macros ------------------------------------------------ */
#define GMM_EPSILON 1e-8
#define GMM_MAX_ITER 100
#define GMM_TOLERANCE 1e-8
#define GMM_SQRT_2PI 2.506628275
...
/* helper functions */
static double GMM_calc_loglikelihood(const GMM_Model* model, const Data* data);
